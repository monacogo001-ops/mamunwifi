...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* 2-Side Layout Overlaid on Full Screen Router Slide (Side-by-Side on Mobile & Desktop) */}
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-12 flex flex-row items-center justify-between gap-4 h-full pt-20 pb-10">
        ...
        <div className="flex-1 text-left max-w-[50%]">
          <AnimatePresence mode="wait">
            ...
            >
              <span className="font-mono text-[10px] sm:text-xs md:text-sm tracking-[0.15em] text-gray-800 block mb-2 sm:mb-3 uppercase font-extrabold">
                [{currentSlide?.tag || "HIGH SPEED BROADBAND"}]
              </span>
              <h1 className="text-2xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-black tracking-tighter uppercase leading-[0.95] drop-shadow-md">
        ...
        <div className="flex-1 text-right flex justify-end max-w-[50%]">
          <AnimatePresence mode="wait">
            <motion.div
              key={currentSlideIndex}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <h2 className="text-xl sm:text-3xl md:text-5xl lg:text-6xl font-black text-black tracking-tighter uppercase leading-[0.95] drop-shadow-md">

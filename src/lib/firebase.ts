...
export const INITIAL_PORTFOLIO_STATE: FullPortfolioState = {
  ...
  projectsData: [
    ...
    },
    {
      ...
      description: "Designed and developed a premium digital media agency website showcasing creative services, brand identity, and client engagement. Built with smooth scroll animations, dynamic portfolio galleries, and modern responsive layouts.",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1200&auto=format&fit=crop",
      link: "https://ronanmediaservice.vercel.app",
      tech: "Next.js, TypeScript, React, Tailwind CSS, Framer Motion, Vercel",
      features: "Dynamic portfolio showcase, Smooth scroll animations, Contact lead generation form, Lightning fast page load speeds",
      isActive: true,
    },
  ],
  certificationsData: [],
